...
class DatasetMapperManager(object):
    """
    This class is used to build a Data object
    ...
    - Then call the generate_Dataset function(dataset_name, is_implicit) to obtain the Data object.
    ...
    def generate_Dataset(self, dataset_name, is_implicit):
        ...
        assert not self.__Dataset_finalized, "Data mappers have already been generated, adding new data is forbidden"
